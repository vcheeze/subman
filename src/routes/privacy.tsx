      ...
      <div className="bg-white border-b shadow-sm">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-slate-900">SubSafe</h1>
          </div>
          <p className="text-lg text-slate-600">Privacy Policy and Terms of Service</p>
          <div className="flex items-center gap-2 mt-3">
            <Calendar className="w-4 h-4 text-slate-500" />
            <span className="text-sm text-slate-500">Last Updated: June 19, 2025</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid gap-8">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="bg-slate-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-slate-900 mb-2">User-Provided Information:</h4>
              ...
              <section>
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-slate-700">Create and manage your SubSafe account</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 shrink-0"></div>
                    <p className="text-slate-700">Process uploaded PDFs to extract subscription details during onboarding</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 shrink-0"></div>
                    <p className="text-slate-700">Provide subscription tracking, reminders, and data insights</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 shrink-0"></div>
                    <p className="text-slate-700">Send email or push notifications for payment reminders (if enabled)</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 shrink-0"></div>
                    <p className="text-slate-700">Improve our app through anonymized analytics</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 shrink-0"></div>
                    <p className="text-slate-700">Ensure security and prevent fraud</p>
                  </div>
                </div>
              </section>
              ...
              <section>
                <h3 className="text-xl font-semibold text-slate-900 mb-4">3. Data Storage and Security</h3>
              ...
              {/* Data Sharing */}
              <section>
                <h3 className="text-xl font-semibold text-slate-900 mb-4">4. Data Sharing</h3>
                <p className="text-slate-700 mb-4">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-slate-300 pl-4">
                    ...
                    <p className="text-slate-700">We use Amazon Textract for PDF parsing and Firebase for notifications. These providers are bound by strict data protection agreements.</p>
                  </div>
                  <div className="border-l-4 border-slate-300 pl-4">
                    <h4 className="font-semibold text-slate-900">Legal Requirements</h4>
                    <p className="text-slate-700">We may disclose data if required by law or to protect our rights and safety.</p>
                  </div>
                  <div className="border-l-4 border-slate-300 pl-4">
                    <h4 className="font-semibold text-slate-900">Anonymized Analytics</h4>
                    <p className="text-slate-700">We use aggregated, non-identifiable data to improve SubSafe.</p>
                  </div>
                </div>
              </section>
              ...
              {/* Your Rights */}
              <section>
                <h3 className="text-xl font-semibold text-slate-900 mb-4">5. Your Rights</h3>
                <p className="text-slate-700 mb-4">You have full control over your data:</p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <section>
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">7. Cookies</h3>
                  <p className="text-slate-700 text-sm">We use minimal cookies for essential functions. You can manage cookie preferences in your browser settings.</p>
                </section>
                <section>
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">8. Data Retention</h3>
                  <p className="text-slate-700 text-sm">Account data is retained while your account is active. Inactive accounts are deleted after 12 months.</p>
                </section>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="p-8 space-y-8">
              ...
              {/* Using SubSafe */}
              <section>
                <h3 className="text-xl font-semibold text-slate-900 mb-4">1. Using SubSafe</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-2">Eligibility</h4>
                    <p className="text-slate-700">You must be at least 13 years old to use SubSafe. If under 18, you need parental consent.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-2">Account Security</h4>
                    <p className="text-slate-700">You need an account to use SubSafe. Keep your login details secure and don't share them.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-2">User Responsibilities</h4>
                    <div className="bg-slate-50 p-4 rounded-lg">
                      <p className="text-slate-700 mb-2">You agree to:</p>
              ...
              {/* Freemium Model */}
              <section>
                <h3 className="text-xl font-semibold text-slate-900 mb-4">2. Freemium Model</h3>
                <div className="grid md:grid-cols-2 gap-6">
              ...
              {/* Your Content */}
              <section>
                <h3 className="text-xl font-semibold text-slate-900 mb-4">3. Your Content</h3>
                <div className="space-y-3">
                  <div className="border-l-4 border-blue-300 pl-4">
                    <h4 className="font-semibold text-slate-900">Ownership</h4>
                    <p className="text-slate-700">You own all subscription data you enter or approve from PDF parsing.</p>
                  </div>
                  <div className="border-l-4 border-blue-300 pl-4">
                    <h4 className="font-semibold text-slate-900">License</h4>
                    <p className="text-slate-700">You grant SubSafe a limited license to process and store your data to provide our services.</p>
                  </div>
                  <div className="border-l-4 border-blue-300 pl-4">
                    <h4 className="font-semibold text-slate-900">Accuracy</h4>
                    <p className="text-slate-700">You're responsible for ensuring the accuracy of your subscription data.</p>
                  </div>
                </div>
              </section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <section>
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">6. Termination</h3>
                  <p className="text-slate-700 text-sm mb-2">You can delete your account anytime. We may suspend accounts for violating these terms.</p>
                  <p className="text-slate-700 text-sm">Termination deletes your data within 30 days.</p>
                </section>
                <section>
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">7. Disclaimers</h3>
                  <p className="text-slate-700 text-sm mb-2">SubSafe is provided "as is." We don't guarantee 100% accuracy of PDF parsing.</p>
                  <p className="text-slate-700 text-sm">We're not responsible for financial decisions based on SubSafe's data.</p>
                </section>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg bg-linear-to-r from-blue-50 to-slate-50">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Questions or Concerns?</h3>
              <p className="text-slate-700 mb-4">
