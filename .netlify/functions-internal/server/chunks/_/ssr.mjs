...
import { createFileRoute, useRouter, useMatch, rootRouteId as rootRouteId$1, ErrorComponent, Link, lazyRouteComponent, redirect, createRootRouteWithContext, Outlet, HeadContent, Scripts, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
...
import { pgTable, timestamp, boolean, text, integer, date, numeric, uuid, serial } from 'drizzle-orm/pg-core';
import { AsyncLocalStorage } from 'node:async_hooks';
import axios from 'redaxios';
import { eq } from 'drizzle-orm';
import { z as z$1 } from 'zod';
import { CustomerPortal, Checkout } from '@polar-sh/tanstack-start';
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/wchen165/Desktop/Peeta/projects/Make_2025/subman/dist";
        const {
          promises: fs
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-Coy3F47y.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-DF-LkZtB.mjs');
    default:
          ...
          products: [
            {
              ...
              slug: "Subman"
              // Custom slug for easy reference in Checkout URL, e.g. /checkout/Subman
            }
          ],
...
const appCss = "/assets/app-dcCWlKVq.css";
const seo = ({
  title,
  description,
  keywords,
  ...
  const tags = [
    ...
    { name: "twitter:creator", content: "@peterchenwei" },
    { name: "twitter:site", content: "@peterchenwei" },
...
const Route$g = createRootRouteWithContext()({
  beforeLoad: async ({ context }) => {
    ...
    return { user: session2 == null ? void 0 : session2.user };
  },
  head: () => ({
    meta: [
      {
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs("body", { children: [
      /* @__PURE__ */ jsx(ThemeProvider, { defaultTheme: "light", children: /* @__PURE__ */ jsx(ScrollArea, { className: "h-screen", children }) }),
...
const $$splitComponentImporter$f = () => import('./terms-AZuKBjzh.mjs');
const Route$f = createFileRoute("/terms")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import('./privacy-nmaIFXch.mjs');
const Route$e = createFileRoute("/privacy")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import('./about-DHduin_m.mjs');
const Route$d = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import('./_authed-D53ihHcW.mjs');
const Route$c = createFileRoute("/_authed")({
  beforeLoad: ({
    context,
    location
  }) => {
...
const $$splitComponentImporter$b = () => import('./_auth-Co33AO_W.mjs');
const $$splitNotFoundComponentImporter$1 = () => import('./_auth-Da9ArSwQ.mjs');
const $$splitErrorComponentImporter = () => import('./_auth-cCfWF6_l.mjs');
const Route$b = createFileRoute("/_auth")({
  beforeLoad: ({
    context
  }) => {
    if (context.user) {
...
const $$splitComponentImporter$a = () => import('./users.route-IwoH50Ib.mjs');
...
const $$splitComponentImporter$9 = () => import('./index-UXRj92vo.mjs');
const Route$9 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import('./users.index-DQWuf0Mz.mjs');
const Route$8 = createFileRoute("/users/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitNotFoundComponentImporter = () => import('./users._userId-BkTYo9nn.mjs');
const $$splitComponentImporter$7 = () => import('./users._userId-CAmVkQdu.mjs');
...
const $$splitComponentImporter$6 = () => import('./settings-DHhV2N5W.mjs');
const Route$6 = createFileRoute("/_authed/settings")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import('./app-landing-B0AGZubD.mjs');
const Route$5 = createFileRoute("/_authed/app-landing")({
...
const fetchSubscriptions = createServerFn({
  method: "GET"
}).validator((d2) => d2).handler(fetchSubscriptions_createServerFn_handler, async ({
  data: userId
}) => {
...
const addSubscription = createServerFn({
  method: "POST"
}).validator((d2) => d2).handler(addSubscription_createServerFn_handler, async ({
  data
}) => {
...
const $$splitComponentImporter$4 = () => import('./app-BinIcplx.mjs');
const Route$4 = createFileRoute("/_authed/app")({
  loader: ({
    context
  }) => {
    var _a;
    return {
      ...
      subscriptions: fetchSubscriptions({
        data: ((_a = context.user) == null ? void 0 : _a.id) || ""
      })
    };
  },
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import('./signup-hf2CSEZK.mjs');
const Route$3 = createFileRoute("/_auth/signup")({
  validateSearch: (search) => ({
    redirect: search.redirect || "/subs/add"
  }),
  beforeLoad: ({
    context,
    search
...
const $$splitComponentImporter$2 = () => import('./signin-B2pJ6qpI.mjs');
const Route$2 = createFileRoute("/_auth/signin")({
  validateSearch: (search) => ({
...
const $$splitComponentImporter$1 = () => import('./demo-BpZOwIam.mjs');
const Route$1 = createFileRoute("/_auth/demo")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./subs.add-DfFRdKkw.mjs');
const Route = createFileRoute("/_authed/subs/add")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
z$1.object({
  name: z$1.string().min(1, "Name is required"),
  amount: z$1.string().min(1, "Amount is required"),
...
const AuthedRoute = Route$c.update({
  id: "/_authed",
  getParentRoute: () => Route$g
});
...
const UsersRouteRoute = Route$a.update({
  id: "/users",
  path: "/users",
  getParentRoute: () => Route$g
});
...
const UsersIndexRoute = Route$8.update({
  id: "/",
  path: "/",
...
const AuthedSettingsRoute = Route$6.update({
  id: "/settings",
  path: "/settings",
  getParentRoute: () => AuthedRoute
});
const AuthedAppLandingRoute = Route$5.update({
  id: "/app-landing",
  path: "/app-landing",
  getParentRoute: () => AuthedRoute
});
const AuthedAppRoute = Route$4.update({
  id: "/app",
  path: "/app",
  getParentRoute: () => AuthedRoute
});
const AuthSignupRoute = Route$3.update({
  id: "/signup",
  path: "/signup",
  getParentRoute: () => AuthRoute
});
const AuthSigninRoute = Route$2.update({
  id: "/signin",
  path: "/signin",
  getParentRoute: () => AuthRoute
});
const AuthDemoRoute = Route$1.update({
  id: "/demo",
  path: "/demo",
  getParentRoute: () => AuthRoute
});
const AuthedSubsAddRoute = Route.update({
  id: "/subs/add",
  path: "/subs/add",
  getParentRoute: () => AuthedRoute
});
const ApiPortalServerRoute = ServerRoute$3.update({
  id: "/api/portal",
  path: "/api/portal",
  getParentRoute: () => rootServerRouteImport
});
const ApiCheckoutServerRoute = ServerRoute$2.update({
  id: "/api/checkout",
  path: "/api/checkout",
  getParentRoute: () => rootServerRouteImport
});
const ApiUsersIdServerRoute = ServerRoute$1.update({
  id: "/api/users/$id",
  path: "/api/users/$id",
  getParentRoute: () => rootServerRouteImport
});
...
const rootServerRouteChildren = {
  ApiCheckoutServerRoute,
  ApiPortalServerRoute,
...
function createRouter() {
  ...
  return routerWithQueryClient(
    createRouter$1({
      routeTree,
      context: { queryClient, user: void 0 },
...
export { DefaultCatchBoundary as D, NotFound as N, Route$7 as R, userQueryOptions as a, useTheme as b, cn as c, Route$4 as d, serverEntry as default, Route$3 as e, Route$2 as f, addSubscription as g, createServerRpc as h, createServerFn as i, getWebRequest as j, auth as k, db as l, subscription as s, usersQueryOptions as u };
